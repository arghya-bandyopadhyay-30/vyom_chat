...
class PromptManager:
    def __init__(self, embedding_service: EmbeddingService):
        ...
        self.prompt_identifier = CategoryIdentifier(embedding_service)
    ...
    def get_category_prompt(self, category: str) -> str:
        return self.category_prompts.get(category, "I currently don't have a template for this category.")
    ...
    def create_user_message(self, text: str, category_prompt: str):
        return HumanMessage(content=f"{category_prompt}\nUser Query: {text}")

    def get_agent_prompt(self, user_query: str) -> list:
        category = self.prompt_identifier.identify_category(user_query)
        print("Category: ", category)

        system_prompt = self.get_system_prompt()
        category_prompt = self.get_category_prompt(category)
        user_prompt = self.create_user_message(user_query, category_prompt)
